...
import { MOCK_MODULES, MOCK_PERMISSIONS } from '../../../core/rbac/mock-data';
import type { Module, Permission } from '../models/models';
import { resolveDependents } from '../../../core/rbac/permission-graph';
import { rbacId } from '../../../core/rbac/rbac-id';
import { RbacStorage } from '../../../core/rbac/rbac-storage';
