...
export const MOCK_USERS: MockRbacUser[] = [
  {
    id: 'u_1',
    name: 'Demo User',
    email: 'demo@blueprint.dev',
    roleId: 'role_support',
  },
  {
    id: 'u_2',
    name: 'Ada Lovelace',
    email: 'ada@blueprint.dev',
    roleId: 'role_admin',
  },
  {
    id: 'u_3',
    name: 'Marcus Webb',
    email: 'marcus@blueprint.dev',
    roleId: 'role_support',
  },
  {
    id: 'u_4',
    name: 'Priya Shah',
    email: 'priya@blueprint.dev',
    roleId: 'role_admin',
  },
  {
    id: 'u_5',
    name: 'Owen Clarke',
    email: 'owen@blueprint.dev',
    roleId: 'role_billing_viewer',
  },
  {
    id: 'u_6',
    name: 'Nina Torres',
    email: 'nina@blueprint.dev',
    roleId: 'role_legacy_ops',
  },
];
