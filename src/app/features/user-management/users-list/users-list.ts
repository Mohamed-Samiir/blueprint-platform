...
export class UsersList {
  ...
  private readonly detailsDialog =
    viewChild.required<DetailsUser>('detailsDialog');
  private readonly deactivateDialog =
    viewChild.required<DeactivateConfirm>('deactivateDialog');
  private readonly changeRoleDialog =
    viewChild.required<ChangeRoleDialog>('changeRoleDialog');
